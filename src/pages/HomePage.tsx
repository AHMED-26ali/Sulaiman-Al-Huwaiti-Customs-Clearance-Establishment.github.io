  ...
  const featuredServices = [
    {
      ...
      features: ['ميناء جدة الإسلامي', 'ميناء الملك عبدالعزيز', 'ميناء ضبا/نيوم'],
    },
    {
      icon: Plane,
      title: 'التخليص الجوي',
      ...
      features: [ 'مطار الملك عبدالعزيز', 'مطار الملك فهد'],
    },
    {
      icon: Truck,
      ...
      features: ['منفذ البطحاء', 'منفذ الحديثة', 'منفذ الدرة'],
    },
    {
      icon: FileText,
