...
export default function Branches() {
  const branches = [
    ...
    },
    {
      ...
      description: 'يُعد الميناء الأكبر والأهم في المملكة على ساحل البحر الأحمر، حيث يربط تجارياً بين ثلاث قارات (آسيا، أفريقيا، وأوروبا). يمثل الشريان الرئيسي لدخول البضائع لمنطقة مكة المكرمة والمشاعر المقدسة، ويتميز بقدرات استيعابية ضخمة للتعامل مع كافة أنواع الشحنات (حاويات، سيارات، ومعدات ثقيلة)، مما يجعله الركيزة الأساسية للتجارة الدولية في المنطقة الغربية..',
      icon: Ship,
