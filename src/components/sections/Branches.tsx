import { MapPin, Ship, Truck, Plane, Sparkles, Anchor, Landmark } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {branches.map((branch, index) => {
            ...
            return (
              <div key={index} className="bg-white/5 backdrop-blur-lg border border-white/10 p-6 rounded-2xl hover:border-white/30 transition-all duration-300 float-animation" style={{ animationDelay: `${index * 150}ms` }}>
