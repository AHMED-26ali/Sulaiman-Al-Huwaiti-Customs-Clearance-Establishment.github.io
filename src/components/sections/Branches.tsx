...
export default function Branches() {
  const branches = [
    ...
    {
      name: 'ميناء الحديثة',
      description: 'يقع على الحدود السعودية–الأردنية شمال المملكة، ويُعد أحد أكبر المنافذ البرية في السعودية. بوابة رئيسية لحركة الشحن البري بين السعودية وبلاد الشام، يوفر خدمات تخليص جمركي متكاملة، خدمات شاحنات، وساحة تبادل بضائع حديثة.',
      icon: Truck,
      location: 'الحدود السعودية-الأردنية - شمال المملكة',
      type: 'منفذ بري',
      color: 'from-cyan-400 to-cyan-600'
    },
    {
      name: 'ميناء ينبع',
      description: 'يقع على ساحل البحر الأحمر في المدينة المنورة، وهو ميناء بحري صناعي وتجاري يخدم مدينة ينبع الصناعية. يُعد منفذًا مهمًا لتصدير البتروكيماويات والمنتجات النفطية، مع خدمات مناولة بضائع عامة، حاويات، وصادرات نفطية وصناعية.',
      icon: Ship,
      location: 'ساحل البحر الأحمر - المدينة المنورة',
      type: 'ميناء بحري',
      color: 'from-teal-400 to-teal-600'
    },
    {
      name: 'ميناء الدمام (ميناء الملك عبدالعزيز)',
      description: 'أكبر ميناء بحري على الخليج العربي في السعودية، يقع في المنطقة الشرقية. مركز رئيسي لاستيراد البضائع للمملكة، خاصة للمنطقة الشرقية والرياض، مع محطات حاويات حديثة، بضائع عامة، مستودعات، ومناطق لوجستية متكاملة.',
      icon: Ship,
      location: 'ساحل الخليج العربي - المنطقة الشرقية',
      type: 'ميناء بحري',
